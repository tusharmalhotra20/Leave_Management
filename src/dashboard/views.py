...
from leave.forms import LeaveCreationForm,DateFilterForm
...
def leaves_approved_list(request):
	...
	if request.method == 'POST':
		leaves = Leave.objects.filter(startdate__icontains=form['startdate'].value())
		context = {
			"form": form,
			'title':'approved leave list',
			"leave_list": leaves,
		}
	return render(request,'dashboard/leaves_approved.html',context)
